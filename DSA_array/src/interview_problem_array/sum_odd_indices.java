...
//		[4, 3]
	...
	private static int[] sum_odd_indices(int[] a, int[] ans, int[][] arr) {
		a=create_prefix_sum_odd_array(a);
	...
	private static int[] create_prefix_sum_odd_array(int[] a) {
		// 
